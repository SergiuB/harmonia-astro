...
tags: ["Therapist", "Coach", "Holistic Approach"]
    ...
    },
    {
      ...
      description:
        [
          ...
          "- Number of sessions: 6 Holistic Massage sessions - Harmonic Reborn",
          "- Discount: Benefit from 20% discount from the total price of services, which brings the final price to 2880lei (instead of 3600lei).",
          "- Booking Frequency: You can choose to participate in sessions weekly, bi-weekly, tri-weekly or monthly, depending on your preferences and needs.",
          "- Validity: The subscription is valid for 5 months from the date of purchase",
          "- Available Hours: Bookings can be made exclusively in morning slots (10:30) or afternoon slots (14:30). Evening slots (18:30) are not available within this subscription.",
          "- Payment: The total amount of the subscription (2,640 lei) will be paid in full before the first booking.",
          "Choose the Harmonic Reborn Subscription to enjoy unique sessions, with a reduced price and flexibility adapted to your needs. This subscription allows you to experience holistic massage in a peaceful and exclusive setting, giving you the possibility to achieve the perfect balance between body, mind and soul.",
          "Limited Places: Each month, 3 Harmonic Reborn subscriptions are available, so I recommend you reserve your place as soon as possible to benefit from this package.",
          "Contact me now to learn more details and to purchase this advantageous subscription.",
    ...
    },
    {
      ...
      description:
        [
          ...
          "✨ Harmonic Reborn (120 min) – holistic massage adapted to your needs, which brings the body into homeostasis and releases deep tensions.",
    ...
    },
    {
      ...
      description:
        [
          ...
          "How It Works",
          "1. Purchase the Gift Card: Directly through a WhatsApp message specifying the desired value.",
          "2. Personalize the Message: Add a personalized message to make the gift even more special.",
          "3. Immediate Delivery: Choose to send the Harmonic Gift Card by email or print it to give it personally.",
          "4. Enjoy Gratitude: Offer the perfect gift that brings joy, health and harmony to loved ones.",
