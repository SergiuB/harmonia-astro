    ...
    },
    {
      ...
      description:
        [
          ...
          "*Price: Assessment session (60–90 min): 400 lei | Training session (90 min): 400 lei",
    ...
    },
{
  ...
  description: [
    "Qi Nei Zang – deep therapeutic abdominal massage and neuro-emotional regulation",
    "The abdomen is more than a space of digestion. It is the place where the body digests and stores emotions, states, experiences, and vital energy.",
    "In Taoist traditions and Traditional Chinese Medicine, emotions, thoughts, mental states, and the physical body are interconnected, and stagnation at any level becomes subtle residue that settles in the body—especially in the abdomen—affecting digestion, breathing, posture, vitality, and emotional well-being.",
    "Qi Nei Zang is a deep abdominal therapy that works directly with the internal organs, abdominal fascia, breath, the body’s emotional memory, and the nervous system, with the Hara / Dantien as its central point—the energetic and structural center of being. Through conscious touch, breath, and presence, the therapy restores communication between the organs and the brain, supporting detoxification, emotional digestion, and self-regulation.",
    "The gentle approach creates the safety needed for emotions and stagnation to be released naturally. When the body feels listened to, it no longer needs to hold on.",
    "Each organ carries an emotional memory:",
    "• The liver holds repressed anger, frustration, and violated boundaries",
    "• The stomach reflects anxiety and the difficulty of digesting life, as well as how we express personal power",
    "• The spleen and pancreas are linked to excessive worry, self-criticism, and self-worth—how we allow ourselves to receive the sweetness of life",
    "• The small intestine stores confusion and overwhelm",
    "• The large intestine carries sadness, grief, and attachments to the past",
    "• The kidneys are the seat of deep fear and vital energy reserves",
    "• The sacred womb holds relational memory, shame, and emotional trauma",
    "Qi Nei Zang supports:",
    "• detoxification and digestive function",
    "• emotional release and self-awareness",
    "• reduction of chronic pain and pelvic imbalances",
    "• improved breathing and posture",
    "• activation of the lymphatic and circulatory systems",
    "• increased vitality and inner stability",
    "The session includes a relaxing massage of the head and neck area, designed to calm the nervous system and prepare the body for deep visceral work.",
    "This is a personalized therapy that works at the root of imbalances—physical, emotional, and energetic.",
    "Your body is not against you. It is simply protecting you in the best way it knows how. Come and listen to what it has to share.",
  ],
  price: "450lei",
  duration: "120min",
  reserveLink: "https://wa.link/yjcax4",
...
For as long as I can remember, I have been deeply connected to the world around me, more sensitive to the environment I live in. I discovered that emotions and psycho-emotional states can somatize and manifest as various physical ailments, and often doctors could not identify the true causes of these problems. Over time I went through a carousel of experiences that affected me on multiple levels. That is how my healing journey began — when I decided to take responsibility for my own recovery and transformation.

The first moment of realization came fairly early, when I started with competitive dance and movement. My inner states began to calm as I trained in performance sport, which I practiced for nearly eight years. After a long break, when some issues returned, I understood how important movement is for me.

Over time I explored many forms of dance and movement (some of which I later taught) — from Latin social dance, contemporary dance, various hip‑hop styles, Axis Syllabus, contact improvisation, dance therapy, to movement disciplines such as calisthenics, natural movement, play‑fight, pilates, and tae‑bo. At the same time I discovered the transformative power of practices like yoga, qigong, Zen, Osho meditations, plant‑based/shamanic approaches, and reiki. I gradually understood how the body’s flexibility, tone and freedom of movement are tightly linked to the flexibility, tone and freedom of thought, moods and emotions.

These personal searches led me through many alternative medicine and complementary therapy methods, studied and applied on myself: massage therapy, sound healing and music, breathing techniques and meditation, dance therapy, herbal medicine, integrative nutrition and naturopathy, aromatherapy, Ayurveda, the connections between illnesses and psycho‑emotional states, and other related approaches.

In 2011 I began practicing manual therapy, and that passion set me on a path of continuous learning. I studied reflexology, somatic and relaxation massage, lymphatic and anticellulite massage, and completed a technician/therapist masseur course. In 2013 I discovered MMT (Mixed Manual Therapy), a complex therapeutic method — a mix of manual techniques drawn from various styles: Thai therapeutic massage, Yumeiho, Russian massage, shiatsu. After three years of intensive study I began applying these techniques at the Varuna Foundation, and since then I have continued to explore practices such as fascial and deep tissue massage, visceral abdominal massage (Chi Nei Tsang), acupressure point therapy, myofascial meridians and fascial adjustments, elements of osteopathy and craniosacral work, and ongoing exploration.

I started studying yoga in 2010 and practicing asana from 2013; later I became certified as an instructor at a Yoga Alliance–registered school. Through yoga practice many changes happened in me, both physically and on other levels — inside and out. The most constant feeling is that calm presence, a state of being beyond being someone, a movement toward harmony and well‑being.

All of this helped me know myself better, to look at myself honestly, to accept myself as I can, and to change where and how I can. They taught me gentleness toward myself and others, opened and shifted my perception, and filled me with wonder at how complex and interconnected everything — including the human being — truly is.

Postural Alignment came as a perfect complement to what I had learned so far. I understood again that postural reeducation is not only about the body but also about inner retraining. Now I know that when body, mind and heart are in harmony, profound change is possible. The search for balance — harmony between mind, body and heart — guides me every day, and what I do, I do from the heart.

I am especially passionate about guiding people to regain balance and health through therapies that not only align the body but the whole being. The lessons from my journey of self‑discovery and healing are something I wish to share with you. Studying all these practices led me to a system that allows me to work with each person in a unique, personalized way. Each method I learned gave me a new perspective on being in this body, and today I integrate them to offer a broader approach that goes beyond relaxation, focusing on recovery and healing to help you embrace and overcome physical and psycho‑emotional limitations, improve posture, and regain mobility.

I know change is a personal journey and everyone has their own path. Yet there is always a way to find balance and improve physical, emotional, energetic and mental well‑being.

The therapies I offer are dedicated to those who want to experience real transformation. Whether it’s releasing pain, restoring correct posture, or reconnecting with yourself, each session is a step toward harmony and balance. Together we will work so you feel better, lighter, and more aligned with yourself.

If you are ready to make a change, I invite you to join me on a journey of alignment, self‑discovery and harmonization.
