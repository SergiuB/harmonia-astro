...
services:
  [
        ...
        ], isGroup: true, price: "350lei", duration: "90min", reserveLink: "https://wa.link/djgx8y" },
    {
      ...
      description:
        [
          "Qi Nei Zang – masaj abdominal terapeutic profund și reglare neuro-emoțională",
          "Abdomenul este mai mult decât un spațiu al digestiei.
Este locul unde corpul digeră și păstrează emoții, stări, experiențe și energie vitală.",
          "În tradițiile taoiste si medicina tradițională chineză, emoțiile, gândurile, stările și fizicul sunt interconectate, iar stagnările la orice nivel devin reziduuri subtile care se depun corp, îndeosebi în abdomen, influențând digestia, respirația, postura, vitalitatea și starea emoțională.",
          "Qi Nei Zang este o terapie abdominală profundă care lucrează direct cu organele interne, fascia abdominală , respirația, memoria emoțională a corpului și sistemul nervos, având ca punct central Hara / Dantien – centrul energetic și structural al ființei. Prin atingere conștientă, respirație și prezență, terapia restabilește comunicarea dintre organe și creier, susținând detoxifierea, digestia emoțională și autoreglarea. ",
          "Abordarea blândă, creează siguranța necesară eliberării emoțiilor si a stagnărilor, în mod natural. 
Când corpul se simte ascultat, nu mai are nevoie să țină.",
          "Fiecare organ poartă o memorie emoțională:",
          "	•	Ficatul reține furia reprimată, frustrarea și limitele încălcate",
          "	•	Stomacul reflectă anxietatea și dificultatea de a 'digera' viața, felul în care exprimăm puterea personală",
          " •	Splina și pancreasul sunt legate de grijă excesivă, autocritică și valoare personală, felul în care ne dăm voie să primim 'dulcele vieții'",
          " •	Intestinul subțire stochează confuzia și suprasolicitarea",
          "	•	Intestinul gros poartă tristețea, doliul și atașamentele față de trecut",
          "	•	Rinichii sunt sediul fricii profunde și al rezervei de energie vitală",
          "	•	Pântecul sacru păstrează memoria relațională, rușinea și traumele emoționale ",
          "Qi Nei Zang susține:",
          "	•	detoxifierea și funcția digestivă",
          "	•	eliberarea emoțională și conștiința de sine",
          "	•	reducerea durerilor cronice și a dezechilibrelor pelviene",
          "•	îmbunătățirea respirației și posturii",
          "	•	activarea sistemului limfatic și circulator",
          "	•	creșterea vitalității și stabilității interioare",
          "Sesiunea include un masaj de relaxare al zonei capului, si gâtului, menit să calmeze sistemul nervos și să pregătească corpul pentru lucrul visceral profund.",
          "Aceasta este o terapie personalizată, care lucrează la rădăcina dezechilibrelor – fizice, emoționale și energetice.",
          "Corpul nu este împotriva ta.
El doar te protejează așa cum poate mai bine.
Hai și tu, să asculți ce are de povestit!",
        ],
      price: "450lei",
      duration: "120min",
